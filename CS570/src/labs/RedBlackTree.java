...
public class RedBlackTree<T extends Comparable<T>> {
    ...
    public RedBlackNode<T> retrieve(T key){
    ...
    public static void main(String[] args) {
        RedBlackTree<String> myDict = new RedBlackTree<>();
        myDict.insert("hello", "world");
        myDict.insert("goodbye", "everyone");
        myDict.insert("name", "student");
        myDict.insert("occupation", "student");
        myDict.insert("year", "2016");
        myDict.insert("gpa", "4.0");
        myDict.insert("lab", "yes");
        myDict.insert("assignment", "no");
        myDict.insert("department", "cs");
        System.out.println("This program is capable of insert(key), retrieve(key), delete(key), containsKey(key)");
        System.out.println("The value searched by key'gpa' is -- " + myDict.retrieve("gpa").value);
        System.out.println("The value searched by key'department' is -- " + myDict.retrieve("department").value);
        /*System.out.println(myDict.containsKey("hello"));
        myDict.delete("hello");
        System.out.println(myDict.containsKey("hello"));*/
    }
}